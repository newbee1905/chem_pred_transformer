"""Original code at: https://github.com/MolecularAI/Chemformer/blob/main/molbart/utils/tokenizers/tokenizers.py"""
...
class ChemformerTokenizer(SMILESTokenizer):
	...
	def __init__(
		...
		self.pad_token_id = self.vocabulary[self.special_tokens["pad"]]
